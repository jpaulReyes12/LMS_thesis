...
angular.module("lmsApp").controller("TabController",["$scope",function(t){t.tab=1,t.setTab=function(n){t.tab=n},t.isSet=function(n){return t.tab===n}}]);